...
const Header = () => {
  ...
  return (
    <header className="text-text-100 flex justify-between px-32 items-center flex-row fixed top-0 left-0 w-full h-16 bg-background-950 border-b border-b-slate-400 z-50 sm:px-5">
      <Link to="/" reloadDocument>
        <p className="text-3xl uppercase font-medium tracking-wide sm:text-lg">
          Filmold
        </p>
      </Link>
      <form className="relative w-[400px] h-8 overflow-hidden sm:w-[200px]">
        <input
          type="text"
